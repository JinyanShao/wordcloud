...
- Phase 2C was released to `main` at `a188565` on 2026-09-09.  Runtime CI, reviewed-learner validation, Pages deployment, and production desktop/390px QA passed; production contains 99 reviewed exact-sense learner aids and keeps `travers|NOM` blocked.
