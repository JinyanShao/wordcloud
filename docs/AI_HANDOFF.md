...
- Phase 2C was released to `main` at `5cb730d72622cdc7142985dd2dff91ce558db4ad` on 2026-09-09. Runtime CI, reviewed-learner validation, Pages deployment, and production desktop/390px QA passed; production contains 99 reviewed exact-sense learner aids and keeps `travers|NOM` blocked.
- Phase 3 was released to `main` at `029e663099d874bcd0f8d709b0299a977b3e92a8` on 2026-09-12. GitHub Actions run `34708731689` completed with runtime CI and Pages deployment successful. The production runtime contains 598 learner aids: Phase 2C preserves 99 reviewed exact-sense aids, and Phase 3 adds 499 externally semantic-authored exact-sense aids from the canonical source `data/phase3/learner-content-499-authored.json`, including 14 v2 learner-primary sense corrections. `travers|NOM` and `cesse|NOM` remain searchable without a learner aid. The Phase 3 learner UI intentionally does not claim `已审核`; full Phase 3 research/audit history remains on `phase3-scale-prep`, and the clean integration branch remains `phase3-main-integration`. **Phase 3 is closed.**
