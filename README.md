...
- **全景词网**：9,000+ 词的交互散点图。半径表示学习进阶（越靠中心越高频、越基础），角度表示可信关系形成的自然词群，坐标构建时计算并固定，每次打开一致。
...
当前规模（见 `data/build-summary.json`）：9,067 个渲染节点 · 9,187 条正式关系 · 21,055 条布局连接 · 45,095 条法语义项定义 · 74.2% 主词至少有一条正式关系 · 全图单连通分量。
