...
- 当前 7,371 个可渲染词汇单位中，7,326 个可与 Démonette lemma+POS 精确对齐（99.4%）。
- 经过跨词性、方向、复杂度和去重规则后，可发布 1,675 条来源确认的词族边。
- eligible 词的正式词族覆盖预计由 18/7,314（0.2%）提升到 2,754/7,314（37.7%），净新增覆盖 2,736 个词。
...
| poli → impoli（均为形容词） | 是 | simple / prefixation | 前缀 · in- |
