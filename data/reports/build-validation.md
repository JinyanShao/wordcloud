...
| 核心词审校关系 | 通过 | 43/43 条具完整审校、来源与例句 |
| 稳定坐标与全图连通 | 通过 | nodes=7,405, components=1, isolated=0 |
| 七类制图信号 | 通过 | derivation=1,708, editorial_seed=136, morphology=3,840, phonetic=6,033, semantic=2,770, skeleton=322, spelling=6,889 |
...
| 静态运行时已导出 | 通过 | graph-data.js=17,478,655 bytes |
