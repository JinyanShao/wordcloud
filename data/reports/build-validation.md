...
| 审校词源、搭配与义项例句 | 通过 | learning entries=8, collocations=16, sourced sense examples=37,697 |
...
| DBnary 义项与语义关系通过质量门 | 通过 | gate=True, entries=9,881, definitions=43,299, sense_lexemes=8,748, semantic=2,746/2,746/2,746, contradictions=0 |
...
| 静态运行时已导出 | 通过 | graph-data.js=18,134,041 bytes |
