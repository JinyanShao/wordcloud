...
| 官方边来源完整 | 通过 | 4472/4472 条有来源 |
| 稳定坐标与全图连通 | 通过 | nodes=7,371, components=1, isolated=0 |
| 七类制图信号 | 通过 | derivation=1,675, editorial_seed=98, morphology=3,769, phonetic=5,998, semantic=2,720, skeleton=325, spelling=6,861 |
...
| 中文释义相似只保留为候选 | 通过 | CFDICT candidates=3,440; visible semantic layout=2,720 (DBnary only) |
...
| 静态运行时已导出 | 通过 | graph-data.js=12,838,281 bytes |
