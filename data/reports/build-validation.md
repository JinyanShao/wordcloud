...
| A1/A2 实词可检索但不强行入图 | 通过 | search-only=1,613, appartenir/VER=present, overlap=0 |
| 运行时学习词范围、内容状态与词形搜索回归 | 通过 | learning=9,017, statuses=9,017, aliases=61,176 |
| 图端点与方向约束 | 通过 | foreign-key errors=0, invalid order=0 |
| 官方边来源完整 | 通过 | 4569/4569 条有来源 |
| 核心词审校关系 | 通过 | 18/18 条具完整审校、来源与例句 |
| 稳定坐标与全图连通 | 通过 | nodes=7,404, components=1, isolated=0 |
| 七类制图信号 | 通过 | derivation=1,708, editorial_seed=113, morphology=3,839, phonetic=6,030, semantic=2,769, skeleton=323, spelling=6,885 |
...
| DBnary 义项与语义关系通过质量门 | 通过 | gate=True, entries=9,881, definitions=43,299, sense_lexemes=8,748, semantic=2,769/2,769/2,769, contradictions=0 |
...
| 静态运行时已导出 | 通过 | graph-data.js=18,146,547 bytes |
