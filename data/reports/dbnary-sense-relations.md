...
- 当前 9,017 个可渲染词汇单位中，8,690 个能对齐至 DBnary 词条（96.4%）。
- 8,690 个词有至少一条法语义项定义，共 43,171 条定义。
- 输入关系折叠为 5,796 条唯一语义边，覆盖 4,622 个词。
...
- 对齐后原始关系 6,366 行，去重后 5,796 条。
- 同一词对同时标为近义与反义的 4 组，全部暂缓发布。
- 未对齐目标：{"synonym": 7336, "antonym": 1080, "approximateSynonym": 546}。这些不会自动扩充当前词表。
